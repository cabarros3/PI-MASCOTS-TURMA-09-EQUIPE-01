...
// Componente separado para gerenciar o uso do `useSearchParams`
function ErrorMessage() {
  const searchParams = useSearchParams();
  const error = searchParams.get("error");

  if (error === "CredentialsSign") {
    return <div className="text-red-500">Erro no Login</div>;
  }
    ...
    <section className="relative flex flex-row w-full">
      ...
      <div className="absolute right-80 top-32 bg-lihtBlue-extralight h-[450px] w-[350px] z-10 shadow-2xl rounded-lg">
        ...
        >
          ...
          {/* Suspense Boundary para gerenciar o carregamento do useSearchParams */}
